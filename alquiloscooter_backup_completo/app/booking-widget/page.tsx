...
import { Calendar, User, Phone, Mail, Car, Clock, Calculator, ChevronRight, Check, CheckCircle2, AlertCircle, Home, Loader2 } from 'lucide-react';
...
export default function BookingWidgetPage() {
  ...
  const [companyLogo, setCompanyLogo] = useState<string>("/alquiloscooter-logo.png");
  ...
  const loadData = async () => {
    try {
      ...
      const locationsRes = await fetch('/api/business-locations/public');
      if (locationsRes.ok) {
        const locationsData = await locationsRes.json();
        setPublicLocations(locationsData);
        
        // Preseleccionar la primera ubicación si existe
        if (locationsData.length > 0) {
          setFormData(prev => ({
            ...prev,
            pickup_location_id: locationsData[0].id.toString(),
            return_location_id: locationsData[0].id.toString()
          }));
        }
      }
  ...
  }, [formData.customer_phone, formData.customer_first_name, formData.customer_last_name]);
    ...
    try {
      ...
      if (response.ok) {
        ...
        setFormData({
          pickup_date: '',
          pickup_time: '09:00',
          pickup_location_id: publicLocations.length > 0 ? publicLocations[0].id.toString() : '',
          return_date: '',
          return_time: '19:00',
          return_location_id: publicLocations.length > 0 ? publicLocations[0].id.toString() : '',
          customer_first_name: '',
          customer_last_name: '',
          customer_email: '',
          customer_phone: '',
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-white to-orange-50">
      {/* Banner con logo - Fondo blanco para destacar */}
      <div className="bg-gradient-to-r from-orange-500 to-orange-600 text-white py-3 shadow-lg">
        <div className="container mx-auto px-4">
          <div className="flex flex-col items-center">
            <div className="bg-white rounded-lg px-6 py-2 shadow-md">
              <img
                        ...
                        <div className="space-y-2">
                          ...
                          <div className="relative">
                            ...
                            <div className="absolute right-3 top-1/2 -translate-y-1/2">
                              ...
                              {!phoneVerification.checking && !phoneVerification.verified && formData.customer_phone && formData.customer_phone.length >= 8 && (
                          ...
                          {!phoneVerification.verified && !phoneVerification.checking && formData.customer_phone && formData.customer_phone.length >= 8 && (
